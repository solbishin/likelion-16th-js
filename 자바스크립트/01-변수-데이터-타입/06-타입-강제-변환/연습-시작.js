...
console.log(product_1_subtotal, typeof product_1_subtotal)

// 두 번째 상품의 소계를 계산하세요.
// 출력 결과: 144000 (number)
let product_2_subtotal = Number(PRODUCT_2_PRICE) * PRODUCT_2_QUANTITY
console.log(product_2_subtotal, typeof product_2_subtotal)

// 세 번째 상품의 소계를 계산하세요.
// 출력 결과: 25000 (number)
let product_3_subtotal = PRODUCT_3_PRICE * Number(PRODUCT_3_QUANTITY)
console.log(product_3_subtotal, typeof product_3_subtotal)


// 전체 상품의 합계를 계산하세요.
// 출력 결과: 239000 (number)
let cart_total = product_1_subtotal + product_2_subtotal + product_3_subtotal
console.log(cart_total, typeof cart_total)

// 배송비를 추가하세요. (3000원, 문자열로 입력됨)
const SHIPPING_FEE = '3000'
// 출력 결과: 242000 (number)
let total_with_shipping = cart_total + Number(SHIPPING_FEE)
console.log(total_with_shipping, typeof cart_total)

// 회원 할인율을 적용하세요. (10% 할인, 문자열로 입력됨)
const MEMBER_DISCOUNT_RATE = '0.1'
// 출력 결과: 24200 (number)
let discount_amount = total_with_shipping * parseFloat(MEMBER_DISCOUNT_RATE)
console.log(discount_amount, typeof discount_amount)

// 최종 결제 금액을 계산하세요.
// 출력 결과: 217800 (number)
let final_payment = total_with_shipping - discount_amount
console.log(final_payment, typeof final_payment)
